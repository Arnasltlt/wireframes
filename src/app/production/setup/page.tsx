...
const mockComments = [
  {
    ...
    text: 'Please ensure we specify the surface finish requirements clearly.',
  ...
  },
  {
    ...
    text: 'We should highlight the critical dimensions in the technical drawings.',
    timestamp: '2023-06-15T11:45:00Z',
  }
];

// Wrapper component that uses useSearchParams
function ProductionSetupContent() {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              {showCollaboration ? 'Hide Comments' : 'Show Comments'}
            </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className={`lg:col-span-${showCollaboration ? '2' : '3'}`}>
            {/* Progress indicator */}
            <div className="mb-8">
